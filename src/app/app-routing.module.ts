...
const routes: Routes = [
  ...
  {
    path: 'intropage',
    loadChildren: () => import('./pages/intropage/intropage.module').then( m => m.IntropagePageModule)
  },
  {
    path: 'ourlawyers',
    loadChildren: () => import('./ourlawyers/ourlawyers.module').then( m => m.OurlawyersPageModule)
  },
  {
    path: 'office',
